...
public class SimulatorView extends JFrame
{
    ...
    private JLabel stepLabel, population, infoLabel, weatherLabel, dayLabel;
    ...
    public SimulatorView(int height, int width)
    {
        ...
        stepLabel.setFont(new Font("Serif",Font.PLAIN, 35));
        infoLabel.setFont(new Font("Serif",Font.PLAIN, 35));
        population.setFont(new Font("Serif",Font.PLAIN, 20));
        weatherLabel.setFont(new Font("Serif",Font.PLAIN, 35));
    ...
    /**
     * Display weather label at the top of the window.
     */
